...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    BOOST_CHECK(addr_ret1.ToString() == "250.1.1.1:8383");
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    BOOST_CHECK(addr_ret2.ToString() == "250.1.1.1:8383");
    ...
    BOOST_CHECK(addr_ret3.ToString() == "250.1.1.1:8383");
}
...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    addrman.Add(CAddress(addr2, NODE_NONE), ResolveService("250.3.1.1", 8383));
    addrman.Add(CAddress(addr3, NODE_NONE), ResolveService("250.3.1.1", 8383));
    addrman.Add(CAddress(addr4, NODE_NONE), ResolveService("250.4.1.1", 8383));
    ...
    addrman.Add(CAddress(addr5, NODE_NONE), ResolveService("250.3.1.1", 8383));
    addrman.Good(CAddress(addr5, NODE_NONE));
    addrman.Add(CAddress(addr6, NODE_NONE), ResolveService("250.3.1.1", 8383));
    addrman.Good(CAddress(addr6, NODE_NONE));
    addrman.Add(CAddress(addr7, NODE_NONE), ResolveService("250.1.1.3", 8383));
    ...
    BOOST_CHECK(addrman.Select().ToString() == "250.4.6.6:8383");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.2.2:9999");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.3.3:9999");
    BOOST_CHECK(addrman.Select().ToString() == "250.4.4.4:8383");
}
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    BOOST_CHECK(info1);
    if (info1)
        BOOST_CHECK(info1->ToString() == "250.1.2.1:8383");
    ...
    BOOST_CHECK(info3);
    if (info3)
        BOOST_CHECK(info3->ToString() == "251.255.2.1:8383");
}
...
BOOST_AUTO_TEST_CASE(addrman_create)
{
    ...
    BOOST_CHECK(pinfo->ToString() == "250.1.2.1:8383");

    CAddrInfo* info2 = addrman.Find(addr1);
    BOOST_CHECK(info2->ToString() == "250.1.2.1:8383");
}
